            ...
            <table class="table table-striped custom-table mb-0 datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <h2 class="table-avatar">
                                <a href="{{url('profile')}}" class="avatar"><img alt="" src="assets/img/profiles/avatar-09.jpg"></a>
                    ...
                    <tr>
                        <td>
                            <h2 class="table-avatar">
                                <a href="{{url('profile')}}" class="avatar"><img alt="" src="assets/img/profiles/avatar-10.jpg"></a>
                    ...
                    <tr>
                        <td>
                            <h2 class="table-avatar">
                                <a href="{{url('profile')}}" class="avatar"><img alt="" src="assets/img/profiles/avatar-05.jpg"></a>
                    ...
                    <tr>
                        <td>
                            <h2 class="table-avatar">
                                <a href="{{url('profile')}}" class="avatar"><img alt="" src="assets/img/profiles/avatar-11.jpg"></a>
