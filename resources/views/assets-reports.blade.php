        ...
        <div class="col-sm-6 col-md-3 col-xxl-2">
            <div class="form-group ">
                <div class="cals-icon">
                    ...
                    <span class="icon-text"><i class="fa fa-folder-open"></i></span>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-3 col-xxl-2">
                ...
                <table class="table table-new custom-table mb-0 datatable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('assets-details') }}" class="table-imgname">
                                    <img src="{{ URL::asset('/assets/img/laptop.png') }}" class="me-2" alt="img">
                                    <span>Laptop</span>
                                </a>
                            </td>
                            <td>AST - 001</td>
                            ...
                            <td class="table-namesplit">
                                <a href="javascript:void(0);" class="table-profileimage">
                                    <img src="{{ URL::asset('/assets/img/profiles/avatar-02.jpg') }}" class="me-2"
                                        alt="img">
                                </a>
                            ...
                            <td>
                                <div class="table-actions d-flex">
                                    <a class="delete-table me-2" data-bs-toggle="modal" data-bs-target="#edit-asset"
                                        ...
                                        <img src="{{ URL::asset('/assets/img/icons/edit.svg') }}" alt="svg">
                                    </a>
                        ...
                        <tr>
                            ...
                            <td class="table-namesplit">
                                <a href="javascript:void(0);" class="table-profileimage" data-bs-toggle="modal"
                                    ...
                                    <img src="{{ URL::asset('/assets/img/profiles/avatar-05.jpg') }}" class="me-2"
                                        alt="img">
                                </a>
                                <a href="javascript:void(0);" class="table-name">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('assets-details') }}" class="table-imgname">
                                    <img src="{{ URL::asset('/assets/img/keyboard.png') }}" class="me-2"
                                        alt="img">
                            ...
                            <td class="table-namesplit">
                                <a href="javascript:void(0);" class="table-profileimage" data-bs-toggle="modal"
                                    data-bs-target="#edit-asset">
                                    <img src="{{ URL::asset('/assets/img/profiles/avatar-03.jpg') }}" class="me-2"
                                        alt="img">
                                </a>
                                <a href="javascript:void(0);" class="table-name">
                                    <span>Harika </span>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" class="table-imgname">
                                    <img src="{{ URL::asset('/assets/img/mouse.png') }}" class="me-2" alt="img">
