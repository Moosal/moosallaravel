            ...
            <div class="fixed-header">
                <div class="navbar">
                    ...
                    <ul class="nav custom-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('voice-call') }}"class="nav-link"><i class="fa fa-phone"></i></a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('video-call') }}"class="nav-link"><i class="fa fa-video-camera"></i></a>
                        </li>
                                        ...
                                        <div class="chat-bubble">
                                            ...
                                            <div class="chat-action-btns">
                                                <ul>
                                                    ...
                                                    <li><a href="#" class="edit-msg"><i class="fa fa-pencil"></i></a>
                                                    </li>
                                                    <li><a href="#" class="del-msg"><i class="fa fa-trash-o"></i></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
