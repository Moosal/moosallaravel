                            ...
                            <table class="table table-hover table-white">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="text"
                                                value="Create, edit delete functionlity" style="min-width:150px">
                                        </td>
                                        <td>
                                        ...
                                        <td><a href="javascript:void(0)" class="text-success font-18" title="Add"><i
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript:void(0)" class="text-danger font-18" title="Remove"><i
