                                     ...
                                     <div class="chat-body">
                                         <div class="chat-bubble">
                                             <div class="chat-content">
                                                 <span class="task-chat-user">Jeffery Lalor</span> <span
                                                     class="file-attached">attached file <i
                                                         class="fa fa-paperclip"></i></span> <span class="chat-time">Today
                                                     at 12:42pm</span>
                                                 <ul class="attach-list">
                                                     <li class="img-file">
                         ...
                         <ul class="chat-user-list">
                             <li>
                                 <a href="#">
                                     <div class="media d-flex">
                                         <span class="avatar"><img alt=""
                                                 src="{{ URL::asset('assets/img/profiles/avatar-16.jpg') }}"></span>
                             ...
                             <li>
                                 <a href="#">
                                     <div class="media d-flex">
                                         <span class="avatar"><img alt=""
                                                 src="{{ URL::asset('assets/img/profiles/avatar-08.jpg') }}"></span>
                                         <div class="media-body media-middle text-nowrap">
